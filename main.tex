...
The graph convolutional network (GCN) which extends Convolutional Neural Networks into graph architecture has been applied in biological information processing and achieved excellent performance. For example, %GCN has been used in the polypharmacy side effects prediction\cite{Zitnik2018},
